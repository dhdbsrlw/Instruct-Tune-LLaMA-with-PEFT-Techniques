...
from lit_llama.adapter_v2_sparseAttn import add_adapter_v2_parameters_to_linear_layers
...
def main(
    ...
    *,
    ...
    checkpoint_path: Path = Path("checkpoints/open-llama/7B/pytorch_model-00002-of-00002.bin"),
